...
// +----------------------------------------------------------------------+
//
// $Id: HTML_IT_Error.php,v 1.1 2002/04/28 07:16:05 sebastian Exp $
...
* @package IT[X]
*/
class HTML_IT_Error extends PEAR_Error {
  ...
  */
  function __construct($msg, $file = __FILE__, $line = __LINE__) {
    return $this->HTML_IT_Error($msg, $file, $line);
  }
  function HTML_IT_Error($msg, $file = __FILE__, $line = __LINE__) {

    $this->PEAR_Error(sprintf("%s [%s on line %d].", $msg, $file, $line));
    
  } // end func HTML_IT_Error
  
} // end class HTML_IT_Error
?>
