...
// +----------------------------------------------------------------------+
//
// $Id: IntegratedTemplate.php,v 1.4 2002/08/31 22:15:19 pajoye Exp $
//
define("IT_OK",                         1);
define("IT_ERROR",                     -1);
...
/**
* Integrated Template - IntegratedTemplate
*
...
* which way you have to parse them. IntegratedTemplate knows that inner1 is a child of block2, there's
...
* @version  $Id: IntegratedTemplate.php,v 1.4 2002/08/31 22:15:19 pajoye Exp $
* @access   public
* @package  IX[X]
*/
class HTML_IT_IntegratedTemplate {
    ...
    * @access   public
    * @see      HTML_IT_IntegratedTemplate()
    */
    var $variablesRegExp = "";
    ...
    * @var    string
    * @see    HTML_IT_IntegratedTemplate(), setRoot()
    */
    var $fileRoot = "";
    ...
    * Now IntegratedTemplate could notice this and skip the preparse.
    *
    * @var    boolean
    */
    ...
    */
    function __construct($root = "") {
        return $this->HTML_IT_IntegratedTemplate($root);
    }
    function HTML_IT_IntegratedTemplate($root = "") {
    ...
    /**
    * Return a textual error message for a IntegratedTemplate error code
    *
    ...
    */
    function parse($block = "__global__", $flag_recursion = false) {
        ...
        $outer = (0 == __main_cnt($regs)) ? $this->blocklist[$block] : preg_replace($regs, $values, $this->blocklist[$block]);
        $empty = (0 == __main_cnt($values)) ? true : false;
    ...
    */
    function getFile($filename) {
        ...
        if ("/" == $filename[0] && "/" == __main_substr($this->fileRoot, -1))
            $filename = __main_substr($filename, 1);
...
} // end class HTML_IT_IntegratedTemplate
?>