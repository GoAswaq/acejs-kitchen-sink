...
class Net_SMTP
{
    ...
    function connect($timeout = null, $persistent = false)
    {
        ...
        global $email_over_ssl_no_verify;
        //modify by Silviu for php 5.6+ compatibility.. otherwise, if verify_peer is true, it won't work!
        //set global $emal_over_ssl_no_verify for when we're using google to connnect or something
        if ($email_over_ssl_no_verify==1){
            $params = array('ssl'=>array('verify_peer' => false,'verify_peer_name'  => false));
        }else{
            $params = array();
        }
        
        $result = $this->_socket->connect($this->host, $this->port,
                                          $persistent, $timeout,$params);
